...
import com.example.quickcash.activities.employer.EmployerVisualizeReputationActivity;
...
public class EmployerVisualizeReputationActivityInstrumentedTest {
    private ActivityScenario<EmployerVisualizeReputationActivity> scenario;
    ...
    public void setup() {
        ...
        scenario = ActivityScenario.launch(EmployerVisualizeReputationActivity.class);
    }
    ...
    public void backButtonNavigatesToEmployeeLandingActivity() {
        ...
        intended(hasComponent(EmployerLandingActivity.class.getName()));
    }
